...
<header class="w-full flex items-center justify-between px-3 shadow bg-neutral-800 h-14 border-b border-neutral-700">
    ...
    <div class="flex-1 gap-2 flex justify-end items-center overflow-hidden h-full pl-6">
        <div class="flex items-center gap-2 whitespace-nowrap text-ellipsis overflow-hidden cursor-pointer h-full hover:opacity-75 transition-all" v-if="user" @click="open({ id: 'user-modal' })">
